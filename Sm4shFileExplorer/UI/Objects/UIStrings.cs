...
namespace Sm4shFileExplorer.UI.Objects
{
    internal static class UIStrings
    {
        ...
        public const string CREATE_PROJECT_FIND_FOLDER = "Please select the root folder of your game dump. This is the folder that *contains* the folder called \"content\". For example, with the path 'desktop/Dump/vol/content/...' you would select 'vol'. This \"content\" folder must contain the files dt00, dt01 and ls. For help with dumping Sm4sh, please refer to the tutorials section of the Sm4sh GameBanana page.";
        ...
        public const string INFO_FILE_MODIFIED = "The resource {0} seems to have been modified. Do you want to include it in the project?";
