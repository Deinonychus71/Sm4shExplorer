...
namespace Sm4shSound.Objects
{
    public class SoundMSBTFile
    {
        ...
        private const string VAR_TITLE = "MsndN_";
        private const string VAR_TITLE2 = "MsndN2_";
        private const string VAR_DESCRIPTION = "MsndW_";
        private const string VAR_DESCRIPTION2 = "MsndO_";
        private const string VAR_SOURCE = "MsndS_";
